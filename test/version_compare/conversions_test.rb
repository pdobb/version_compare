    ...
    describe VersionCompare::Conversions do
      ...
      describe ".Conversion" do
        ...
        it "works on arrays" do
          ...
          klazz.ComparableVersion(%w[1 2 3 4]).
            must_equal klazz.ComparableVersion("1.2.3.4")
        end
      ...
      describe "#to_a" do
        it "returns an array of integers" do
          ...
          klazz.ComparableVersion(%w[1 2 3 4]).to_a.
            must_equal [1, 2, 3, 4]
        end
      end
      ...
      context "CustomObjects" do
        context "without #to_comparable_version" do
          it "raises TypeError when attempting to convert custom objects that "\
             "don't implement #to_comparable_version" do
